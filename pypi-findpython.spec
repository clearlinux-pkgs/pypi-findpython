...
Source0  : https://files.pythonhosted.org/packages/9e/9b/5565a5fb78f7f4d06ccbf10c7d4e43321fe24158e0b7750be9dd7db11ca9/findpython-0.6.2.tar.gz
...
%prep
%setup -q -n findpython-0.6.2
cd %{_builddir}/findpython-0.6.2
pushd ..
cp -a findpython-0.6.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729177098
