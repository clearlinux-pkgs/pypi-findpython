...
Source0  : https://files.pythonhosted.org/packages/29/57/a35de26696baa005ddcfce8af495fb8cdb75942ebebf1cf219a04706fc81/findpython-0.6.1.tar.gz
...
%prep
%setup -q -n findpython-0.6.1
cd %{_builddir}/findpython-0.6.1
pushd ..
cp -a findpython-0.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713456757
