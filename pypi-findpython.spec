...
Source0  : https://files.pythonhosted.org/packages/2d/73/ab2c4fb7972145c1595c07837cffc1456c1510a908f5c8bda9745930ee60/findpython-0.6.3.tar.gz
...
%prep
%setup -q -n findpython-0.6.3
cd %{_builddir}/findpython-0.6.3
pushd ..
cp -a findpython-0.6.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742455728
